...
const BAProgramDetail = () => {
  ...
  const program = {
    ...
    description: 'Our BA program provides a rich interdisciplinary education. Students explore the intersections of literature, psychology, and social sciences while gaining digital literacy through modern research tools and professional cloud certifications.',
    semesters: [
      { semester: 'Semester I', subjects: ['English Literature', 'Introduction to Sociology', 'Political Theory', 'Environmental Studies'] },
      { semester: 'Semester II', subjects: ['Modern History', 'Social Psychology', 'Public Administration', 'Communication Skills'] },
      { semester: 'Semester III', subjects: ['Development Economics', 'Media Studies', 'Research Methodology', 'Digital Literacy'] },
      { semester: 'Semester IV', subjects: ['Human Rights', 'Global Politics', 'Content Strategy', 'Social Data Analysis'] },
      { semester: 'Semester V', subjects: ['Public Policy', 'Organizational Behavior', 'Creative Writing', 'Electives'] },
      { semester: 'Semester VI', subjects: ['Capstone Project', 'Internship', 'Professional Ethics', 'Dissertation'] }
    ],
    highlights: [
      'Advanced Digital Research Labs',
      'Strategic Certifications: AWS, Google Cloud',
      'Hands-on Social Impact Projects',
      'Workshops on Civil Services (UPSC) Prep',
      'Collaboration with NGOs and Media Houses',
      'State-of-the-art Creative Design Studio'
    ],
    specializations: ['Psychology', 'English Literature', 'Political Science', 'Economics', 'Digital Media'],
    skills: ['Critical Thinking', 'Public Speaking', 'Social Research', 'Content Creation', 'Project Management', 'Policy Analysis'],
    career_paths: [
      { role: 'Content Strategist', company: 'Digital Media & Marketing Agencies', salary: '5-9 LPA' },
      { role: 'Public Policy Analyst', company: 'Think Tanks & Government Orgs', salary: '6-12 LPA' },
      { role: 'HR Manager', company: 'Corporate & Tech Sectors', salary: '5-10 LPA' },
      { role: 'Social Researcher', company: 'Research Institutions & NGOs', salary: '4-8 LPA' }
    ],
    eligibility: ['12th Pass from recognized board', 'Any stream (Arts/Science/Commerce)', 'Minimum 50% aggregate marks', 'Strong communication skills preferred']
  };
