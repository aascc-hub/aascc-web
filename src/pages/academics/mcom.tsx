...
const MComProgramDetail = () => {
  ...
  const program = {
    ...
    description: 'This program offers specialized knowledge in accounting, taxation, and investment. It integrates professional certifications and research methodology to ensure students are ready for the global market.',
    semesters: [
      { semester: 'Semester I', subjects: ['Management Accounting', 'Business Environment', 'Managerial Economics', 'Statistical Analysis'] },
      { semester: 'Semester II', subjects: ['Financial Management', 'Marketing Management', 'Legal Framework of Business', 'E-Commerce'] },
      { semester: 'Semester III', subjects: ['Corporate Tax Planning', 'Research Methodology', 'Financial Institutions', 'Accounting for Decisions'] },
      { semester: 'Semester IV', subjects: ['Strategic Management', 'International Business', 'Corporate Governance', 'Dissertation/Project'] }
    ],
    highlights: [
      'Advanced Corporate Internship Programs',
      'Case Study based Learning Approach',
      'Expert Workshops on GST & Audit',
      'Financial Modeling with Python/R',
      'NET/SET Coaching Assistance',
      'Networking with Industry Professionals'
    ],
    specializations: ['Advanced Accounting', 'Finance & Control', 'Taxation & Auditing', 'International Business'],
    skills: ['Strategic Decision Making', 'Advanced Financial Reporting', 'Investment Analysis', 'Business Valuation', 'Tax Planning', 'Research Analytics'],
    career_paths: [
      { role: 'Financial Manager', company: 'MNCs & Banks', salary: '8-14 LPA' },
      { role: 'Chief Accountant', company: 'Corporate Firms', salary: '7-12 LPA' },
      { role: 'Business Analyst', company: 'Consultancy Firms', salary: '6-11 LPA' },
      { role: 'Assistant Professor', company: 'Academic Institutions', salary: '5-10 LPA' }
    ],
    eligibility: ['Graduation (B.Com/BBA) from recognized university', 'Minimum 50% aggregate marks', 'Strong foundation in Accounting']
  };
