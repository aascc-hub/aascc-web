...
const BScProgramDetail = () => {
  ...
  const program = {
    ...
    description: 'Our B.Sc program emphasizes hands-on laboratory experience and research-led learning. Students engage with complex scientific problems and develop solutions through systematic experimentation.',
    semesters: [
      { semester: 'Semester I', subjects: ['Physics - I', 'Chemistry - I', 'Mathematics - I', 'English Communication'] },
      { semester: 'Semester II', subjects: ['Physics - II', 'Chemistry - II', 'Mathematics - II', 'Environmental Science'] },
      { semester: 'Semester III', subjects: ['Mechanics & Waves', 'Organic Chemistry', 'Calculus', 'Digital Electronics'] },
      { semester: 'Semester IV', subjects: ['Optics', 'Inorganic Chemistry', 'Algebra', 'Skill Enhancement'] },
      { semester: 'Semester V', subjects: ['Quantum Mechanics', 'Physical Chemistry', 'Numerical Methods', 'Lab Specialization'] },
      { semester: 'Semester VI', subjects: ['Nuclear Physics', 'Analytical Chemistry', 'Complex Analysis', 'Major Research Project'] }
    ],
    highlights: [
      'State-of-the-art Research Laboratories',
      'Hands-on Practical Training Sessions',
      'Regular Science Seminars & Exhibitions',
      'Collaborations with Research Institutions',
      'Focus on Scientific Writing & Documentation',
      'Career Guidance for Higher Studies (M.Sc/PhD)'
    ],
    specializations: ['Physics', 'Chemistry', 'Mathematics', 'Computer Science', 'Electronics'],
    skills: ['Analytical Reasoning', 'Lab Techniques', 'Data Observation', 'Scientific Research', 'Logical Problem Solving', 'Technical Writing'],
    career_paths: [
      { role: 'Research Assistant', company: 'Scientific Labs & Institutes', salary: '4-7 LPA' },
      { role: 'Data Analyst', company: 'Tech & Research Firms', salary: '5-9 LPA' },
      { role: 'Quality Control Officer', company: 'Manufacturing & Pharma', salary: '3-6 LPA' },
      { role: 'Technical Consultant', company: 'Private Tech Sectors', salary: '5-10 LPA' }
    ],
    eligibility: ['12th Pass from recognized board', 'Science stream (PCM/PCB) mandatory', 'Minimum 50% aggregate marks', 'Strong analytical aptitude']
  };
