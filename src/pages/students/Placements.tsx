...
<div className="mb-16">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    {/* Professional & Core Commerce Skills */}
    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-8">
      <h3 className="text-2xl font-bold text-blue-900 mb-6">Core Commerce Skills</h3>
      <ul className="space-y-3 text-gray-700">
        <li className="flex items-start">
          <div className="w-2 h-2 bg-blue-900 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          <span>Advanced Financial Accounting & Tally Prime</span>
        </li>
        <li className="flex items-start">
          <div className="w-2 h-2 bg-blue-900 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          <span>Direct & Indirect Taxation (GST, Income Tax)</span>
        </li>
        <li className="flex items-start">
          <div className="w-2 h-2 bg-blue-900 rounded-full mt-2 mr-3 flex-shrink-0"></div>
        ...
        <li className="flex items-start">
          <div className="w-2 h-2 bg-blue-900 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          <span>Advanced Excel for Business Analytics</span>
        </li>
        <li className="flex items-start">
          <div className="w-2 h-2 bg-blue-900 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          <span>Corporate Law & Auditing Practices</span>
        </li>
      </ul>
    </div>
    ...
    <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg p-8">
      <h3 className="text-2xl font-bold text-blue-900 mb-6">Employability Skills</h3>
      <ul className="space-y-3 text-gray-700">
        <li className="flex items-start">
          <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          <span>Business Communication & Corporate Correspondence</span>
        </li>
        <li className="flex items-start">
          <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          <span>Aptitude Training & Numerical Ability</span>
        </li>
        <li className="flex items-start">
          <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
        ...
        <li className="flex items-start">
          <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          <span>Professional Ethics & Workplace Etiquette</span>
        </li>
        <li className="flex items-start">
          <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
          <span>Analytical Reasoning & Decision Making</span>
        </li>
      </ul>
    </div>
  </div>
